...
export function KlientenstammdatenDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = false, enablePhotoLocation = true }: KlientenstammdatenDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'klientenstammdaten');
      await onSubmit(clean as Klientenstammdaten['fields']);
      onClose();
    } finally {
      setSaving(false);
    }
  ...
  const DIALOG_INTENT = defaultValues ? 'Klientenstammdaten bearbeiten' : 'Klientenstammdaten hinzufügen';
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={v => setFields(f => ({ ...f, pflegegrad: v === 'none' ? undefined : v as any }))}
            >
