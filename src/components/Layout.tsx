...
import { FileText, LayoutDashboard, Menu, Settings, Undo2 } from 'lucide-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';

// ⚡ Customize these for your app
const APP_TITLE = 'PflegeDoc Pro';
...
const navigation = [
  ...
  { name: 'Medikamentenplan', href: '/medikamentenplan', icon: FileText },
  { name: 'Klientenstammdaten', href: '/klientenstammdaten', icon: FileText },
  { name: 'Wunddokumentation', href: '/wunddokumentation', icon: FileText },
  { name: 'Vitalwerte-Erfassung', href: '/vitalwerte-erfassung', icon: FileText },
  { name: 'Tourenplanung', href: '/tourenplanung', icon: FileText },
  { name: 'Pflegeplanung', href: '/pflegeplanung', icon: FileText },
  { name: 'Leistungsnachweis', href: '/leistungsnachweis', icon: FileText },
  { name: 'Pflegedurchführung', href: '/pflegedurchfuehrung', icon: FileText },
  { name: 'Pflegefachkräfte', href: '/pflegefachkraefte', icon: FileText },
];

const externalNavigation = [
  { name: 'Medikamentenplan', href: '/gateway/apps/69a2b37dddc4d201a06278f2?template=list_page', icon: FileText },
  { name: 'Klientenstammdaten', href: '/gateway/apps/69a2b374e8f430d34bb01a82?template=list_page', icon: FileText },
  { name: 'Wunddokumentation', href: '/gateway/apps/69a2b380da2d16583370c8e5?template=list_page', icon: FileText },
  { name: 'Vitalwerte-Erfassung', href: '/gateway/apps/69a2b37f9988ba76e2b41821?template=list_page', icon: FileText },
  { name: 'Tourenplanung', href: '/gateway/apps/69a2b37f4ba887f6b8f00834?template=list_page', icon: FileText },
  { name: 'Pflegeplanung', href: '/gateway/apps/69a2b37e59b1455ce4d42f6d?template=list_page', icon: FileText },
  { name: 'Leistungsnachweis', href: '/gateway/apps/69a2b382c9dc1d577bd6c8ec?template=list_page', icon: FileText },
  { name: 'Pflegedurchführung', href: '/gateway/apps/69a2b3815d9195a12c0668b1?template=list_page', icon: FileText },
  { name: 'Pflegefachkräfte', href: '/gateway/apps/69a2b37ce4a6c238edbda7f7?template=list_page', icon: FileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69a2b37dddc4d201a06278f2?template=list_page"
